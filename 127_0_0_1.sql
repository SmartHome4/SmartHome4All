...
--
-- Хост: 127.0.0.1
-- Время создания: Авг 21 2017 г., 11:51
...
('root', '[{\"db\":\"smarthome\",\"table\":\"elements_events\"}]');
...
('root', '2017-06-26 13:55:00', '{\"lang\":\"ru\",\"collation_connection\":\"utf8mb4_unicode_ci\"}');
...
--
-- Структура таблицы `elements_events`
--
...
--
-- Дамп данных таблицы `elements_events`
--

INSERT INTO `elements_events` (`element_id`, `t_class`, `f_class`, `ongoing_class`, `on_value`, `off_value`, `ongoing_value`, `enable`) VALUES
('secure_alarm', 'btn btn-xs btn-success', 'btn btn-xs btn-warning', 'btn btn-xs btn-warning', 'Включена', 'Отключена', 'Отключена', 0),
('secure_camera', 'btn btn-xs btn-success', 'btn btn-xs btn-warning', 'btn btn-xs btn-success', 'Включено', 'Выключено', 'Включено', 1),
('secure_doors', 'btn btn-xs btn-success', 'btn btn-xs btn-warning', 'btn btn-xs btn-warning', 'Закрыты', 'Открыты', 'Открыты', 0),
('secure_garage', 'btn btn-xs btn-success', 'btn btn-xs btn-warning', 'btn btn-xs btn-success', 'Закрыт', 'Открыт', 'Закрыт', 1);
...
--
-- Индексы таблицы `elements_events`
--
ALTER TABLE `elements_events`
...
(1, 'Default', '', 1, '2017-06-26 16:56:42', '2017-06-26 16:56:42');
...
(1, 'Рубль', 'RUB', '', ' р.', '2', 1.00000000, 1, '2017-06-26 16:05:39'),
(2, 'US Dollar', 'USD', '$', '', '2', 0.01690000, 1, '2017-06-26 15:57:05'),
(3, 'Euro', 'EUR', '', '€', '2', 0.01510000, 1, '2017-06-26 15:57:05');
...
(178, 0, 'config', 'config_email', 'olegefm@yandex.ru', 0),
...
(179, 0, 'config', 'config_encryption', '', 0),
...
(1, 1, 'admin', '998bc6906b4687c3cd5fe794ca28890aabec61be', 'DbAqqQuk1', 'John', 'Doe', 'olegefm@yandex.ru', '', '', '::1', 1, '2017-06-26 16:56:42');
